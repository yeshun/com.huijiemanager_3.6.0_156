.class Landroid/support/v4/h/a$d$2;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/support/v4/h/a$d;->a(Landroid/print/PrintAttributes;ILandroid/graphics/Bitmap;Landroid/os/ParcelFileDescriptor;Landroid/os/CancellationSignal;Landroid/print/PrintDocumentAdapter$WriteResultCallback;)V
.end annotation
...
.field final synthetic h:Landroid/support/v4/h/a$d;


# direct methods
.method constructor <init>(Landroid/support/v4/h/a$d;Landroid/os/CancellationSignal;Landroid/print/PrintAttributes;Landroid/graphics/Bitmap;Landroid/print/PrintAttributes;ILandroid/os/ParcelFileDescriptor;Landroid/print/PrintDocumentAdapter$WriteResultCallback;)V
    .locals 0

    .prologue
    .line 463
    iput-object p1, p0, Landroid/support/v4/h/a$d$2;->h:Landroid/support/v4/h/a$d;

    iput-object p2, p0, Landroid/support/v4/h/a$d$2;->a:Landroid/os/CancellationSignal;

    iput-object p3, p0, Landroid/support/v4/h/a$d$2;->b:Landroid/print/PrintAttributes;

    iput-object p4, p0, Landroid/support/v4/h/a$d$2;->c:Landroid/graphics/Bitmap;

    iput-object p5, p0, Landroid/support/v4/h/a$d$2;->d:Landroid/print/PrintAttributes;

    iput p6, p0, Landroid/support/v4/h/a$d$2;->e:I

    iput-object p7, p0, Landroid/support/v4/h/a$d$2;->f:Landroid/os/ParcelFileDescriptor;

    iput-object p8, p0, Landroid/support/v4/h/a$d$2;->g:Landroid/print/PrintDocumentAdapter$WriteResultCallback;
...
.method protected varargs a([Ljava/lang/Void;)Ljava/lang/Throwable;
    ...
    .line 467
    :try_start_0
    iget-object v1, p0, Landroid/support/v4/h/a$d$2;->a:Landroid/os/CancellationSignal;
    ...
    iget-object v1, p0, Landroid/support/v4/h/a$d$2;->h:Landroid/support/v4/h/a$d;

    iget-object v1, v1, Landroid/support/v4/h/a$d;->a:Landroid/content/Context;

    iget-object v3, p0, Landroid/support/v4/h/a$d$2;->b:Landroid/print/PrintAttributes;
    ...
    iget-object v3, p0, Landroid/support/v4/h/a$d$2;->c:Landroid/graphics/Bitmap;

    iget-object v4, p0, Landroid/support/v4/h/a$d$2;->b:Landroid/print/PrintAttributes;
    ...
    .line 474
    invoke-static {v1, v3, v4}, Landroid/support/v4/h/a$d;->a(Landroid/support/v4/h/a$d;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    iget-boolean v1, v1, Landroid/support/v4/h/a$d;->d:Z
    ...
    .line 499
    :goto_1
    iget-object v5, p0, Landroid/support/v4/h/a$d$2;->h:Landroid/support/v4/h/a$d;
    ...
    iget v8, p0, Landroid/support/v4/h/a$d$2;->e:I

    .line 499
    invoke-static {v5, v6, v7, v1, v8}, Landroid/support/v4/h/a$d;->a(Landroid/support/v4/h/a$d;IILandroid/graphics/RectF;I)Landroid/graphics/Matrix;

    move-result-object v5

    .line 503
    iget-object v6, p0, Landroid/support/v4/h/a$d$2;->h:Landroid/support/v4/h/a$d;

    iget-boolean v6, v6, Landroid/support/v4/h/a$d;->d:Z
    ...
    .line 530
    iget-object v1, p0, Landroid/support/v4/h/a$d$2;->f:Landroid/os/ParcelFileDescriptor;
    :try_end_2
    ...
    :goto_3
    :try_start_4
    iget-object v1, p0, Landroid/support/v4/h/a$d$2;->c:Landroid/graphics/Bitmap;
    ...
    iget-object v6, p0, Landroid/support/v4/h/a$d$2;->d:Landroid/print/PrintAttributes;
    ...
    iget-object v4, p0, Landroid/support/v4/h/a$d$2;->f:Landroid/os/ParcelFileDescriptor;
...
.method protected a(Ljava/lang/Throwable;)V
    ...
    .prologue
    .line 549
    iget-object v0, p0, Landroid/support/v4/h/a$d$2;->a:Landroid/os/CancellationSignal;
    ...
    .line 551
    iget-object v0, p0, Landroid/support/v4/h/a$d$2;->g:Landroid/print/PrintDocumentAdapter$WriteResultCallback;
...
.method protected synthetic doInBackground([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/h/a$d$2;->a([Ljava/lang/Void;)Ljava/lang/Throwable;
...
.method protected synthetic onPostExecute(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/h/a$d$2;->a(Ljava/lang/Throwable;)V
