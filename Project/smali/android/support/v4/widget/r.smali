...
.method private static a(Landroid/support/v4/widget/r$a;)Landroid/widget/SearchView$OnCloseListener;
    .locals 1
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/widget/r$2;-><init>(Landroid/support/v4/widget/r$a;)V

    return-object v0
.end method

.method private static a(Landroid/support/v4/widget/r$c;)Landroid/widget/SearchView$OnQueryTextListener;
    .locals 1
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/widget/r$1;-><init>(Landroid/support/v4/widget/r$c;)V
...
.method public static a(Landroid/view/View;)Ljava/lang/CharSequence;
    ...
    .prologue
    .line 255
    invoke-static {p0}, Landroid/support/v4/widget/r;->e(Landroid/view/View;)V
...
.method public static a(Landroid/view/View;Landroid/support/v4/widget/r$a;)V
    .locals 1
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
    ...
    invoke-static {p1}, Landroid/support/v4/widget/r;->a(Landroid/support/v4/widget/r$a;)Landroid/widget/SearchView$OnCloseListener;
...
.method public static a(Landroid/view/View;Landroid/support/v4/widget/r$c;)V
    .locals 1
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
    ...
    invoke-static {p1}, Landroid/support/v4/widget/r;->a(Landroid/support/v4/widget/r$c;)Landroid/widget/SearchView$OnQueryTextListener;
