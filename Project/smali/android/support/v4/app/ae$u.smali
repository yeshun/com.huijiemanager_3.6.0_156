.class public abstract Landroid/support/v4/app/ae$u;
...
# instance fields
.field protected e:Landroid/support/v4/app/ae$e;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/ae$u;->h:Z
...
.method private a()I
    ...
    .line 2228
    iget-object v0, p0, Landroid/support/v4/app/ae$u;->e:Landroid/support/v4/app/ae$e;

    iget-object v0, v0, Landroid/support/v4/app/ae$e;->a:Landroid/content/Context;
    ...
    invoke-static {v0, v4, v3}, Landroid/support/v4/app/ae$u;->a(FFF)F
...
.method private a(IIII)Landroid/graphics/Bitmap;
    ...
    :cond_0
    invoke-direct {p0, v0, p4, p2}, Landroid/support/v4/app/ae$u;->a(III)Landroid/graphics/Bitmap;
    ...
    .line 2193
    iget-object v2, p0, Landroid/support/v4/app/ae$u;->e:Landroid/support/v4/app/ae$e;
...
.method public a(II)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, p1, p2, v0}, Landroid/support/v4/app/ae$u;->a(III)Landroid/graphics/Bitmap;
...
.method public a(ZIZ)Landroid/widget/RemoteViews;
    ...
    iget-object v1, p0, Landroid/support/v4/app/ae$u;->e:Landroid/support/v4/app/ae$e;
    ...
    invoke-virtual {v1}, Landroid/support/v4/app/ae$e;->i()I
    ...
    iget-object v1, v1, Landroid/support/v4/app/ae$e;->g:Landroid/graphics/Bitmap;
    ...
    iget-object v5, p0, Landroid/support/v4/app/ae$u;->e:Landroid/support/v4/app/ae$e;

    iget-object v5, v5, Landroid/support/v4/app/ae$e;->g:Landroid/graphics/Bitmap;
    ...
    iget-object v1, v1, Landroid/support/v4/app/ae$e;->L:Landroid/app/Notification;
    ...
    .line 2059
    iget-object v6, p0, Landroid/support/v4/app/ae$u;->e:Landroid/support/v4/app/ae$e;

    iget-object v6, v6, Landroid/support/v4/app/ae$e;->L:Landroid/app/Notification;

    iget v6, v6, Landroid/app/Notification;->icon:I

    iget-object v7, p0, Landroid/support/v4/app/ae$u;->e:Landroid/support/v4/app/ae$e;

    .line 2063
    invoke-virtual {v7}, Landroid/support/v4/app/ae$e;->j()I

    move-result v7

    .line 2059
    invoke-direct {p0, v6, v1, v5, v7}, Landroid/support/v4/app/ae$u;->a(IIII)Landroid/graphics/Bitmap;
    ...
    iget-object v1, v1, Landroid/support/v4/app/ae$e;->b:Ljava/lang/CharSequence;
    ...
    iget-object v5, v5, Landroid/support/v4/app/ae$e;->b:Ljava/lang/CharSequence;
    ...
    iget-object v1, v1, Landroid/support/v4/app/ae$e;->c:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Landroid/support/v4/app/ae$e;->c:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Landroid/support/v4/app/ae$e;->g:Landroid/graphics/Bitmap;
    ...
    iget-object v5, v5, Landroid/support/v4/app/ae$e;->h:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Landroid/support/v4/app/ae$e;->h:Ljava/lang/CharSequence;
    ...
    iget-object v1, v1, Landroid/support/v4/app/ae$e;->n:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Landroid/support/v4/app/ae$e;->n:Ljava/lang/CharSequence;
    ...
    invoke-virtual {v1}, Landroid/support/v4/app/ae$e;->h()J
    ...
    iget-boolean v1, v1, Landroid/support/v4/app/ae$e;->l:Z
    ...
    iget-object v3, p0, Landroid/support/v4/app/ae$u;->e:Landroid/support/v4/app/ae$e;

    .line 2151
    invoke-virtual {v3}, Landroid/support/v4/app/ae$e;->h()J
    ...
    iget-object v5, v5, Landroid/support/v4/app/ae$e;->L:Landroid/app/Notification;

    iget v5, v5, Landroid/app/Notification;->icon:I

    const/4 v6, -0x1

    invoke-virtual {p0, v5, v6}, Landroid/support/v4/app/ae$u;->a(II)Landroid/graphics/Bitmap;
    ...
    iget v5, v5, Landroid/support/v4/app/ae$e;->i:I
    ...
    iget v2, v2, Landroid/support/v4/app/ae$e;->i:I
...
.method public a(Landroid/support/v4/app/ae$e;)V
    ...
    .line 1954
    iput-object p1, p0, Landroid/support/v4/app/ae$u;->e:Landroid/support/v4/app/ae$e;
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/app/ae$e;->a(Landroid/support/v4/app/ae$u;)Landroid/support/v4/app/ae$e;
...
.method public a(Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;)V
    ...
    .line 2210
    invoke-direct {p0, p1}, Landroid/support/v4/app/ae$u;->a(Landroid/widget/RemoteViews;)V
    ...
    .line 2217
    invoke-direct {p0}, Landroid/support/v4/app/ae$u;->a()I
