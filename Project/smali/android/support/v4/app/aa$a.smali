...
.method a()V
    ...
    .line 255
    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/aa$a;->d:Landroid/support/v4/content/f;
    ...
    invoke-interface {v0, v1, v2}, Landroid/support/v4/app/z$a;->a(ILandroid/os/Bundle;)Landroid/support/v4/content/f;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/aa$a;->d:Landroid/support/v4/content/f;
    ...
    iget-object v2, p0, Landroid/support/v4/app/aa$a;->d:Landroid/support/v4/content/f;
    ...
    invoke-virtual {v0, v1, p0}, Landroid/support/v4/content/f;->a(ILandroid/support/v4/content/f$c;)V
...
.method public a(Landroid/support/v4/content/f;)V
    ...
    iget-object v0, v0, Landroid/support/v4/app/aa;->c:Landroid/support/v4/k/r;
    ...
    iget-object v1, v1, Landroid/support/v4/app/aa;->c:Landroid/support/v4/k/r;
    ...
    .line 404
    invoke-virtual {p0}, Landroid/support/v4/app/aa$a;->g()V
...
.method public a(Landroid/support/v4/content/f;Ljava/lang/Object;)V
    ...
    .line 444
    invoke-virtual {p0, p1, p2}, Landroid/support/v4/app/aa$a;->b(Landroid/support/v4/content/f;Ljava/lang/Object;)V

    .line 454
    :cond_7
    iget-object v0, p0, Landroid/support/v4/app/aa$a;->o:Landroid/support/v4/app/aa;

    iget-object v0, v0, Landroid/support/v4/app/aa;->d:Landroid/support/v4/k/r;
    ...
    iget-object v0, v0, Landroid/support/v4/app/aa;->j:Landroid/support/v4/app/o;
...
.method b(Landroid/support/v4/content/f;Ljava/lang/Object;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, v1, Landroid/support/v4/app/aa;->j:Landroid/support/v4/app/o;
    ...
    iget-object v0, v0, Landroid/support/v4/app/q;->A:Ljava/lang/String;
    ...
    iput-object v2, v1, Landroid/support/v4/app/q;->A:Ljava/lang/String;
    ...
    .line 475
    invoke-virtual {p1, p2}, Landroid/support/v4/content/f;->c(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/app/z$a;->a(Landroid/support/v4/content/f;Ljava/lang/Object;)V
    :try_end_0
    ...
    iput-object v1, v0, Landroid/support/v4/app/q;->A:Ljava/lang/String;
    ...
    iget-object v2, v2, Landroid/support/v4/app/aa;->j:Landroid/support/v4/app/o;
    ...
    iput-object v1, v2, Landroid/support/v4/app/q;->A:Ljava/lang/String;
...
.method c()V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/app/aa$a;->b(Landroid/support/v4/content/f;Ljava/lang/Object;)V
...
.method e()V
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/content/f;->a(Landroid/support/v4/content/f$c;)V

    .line 326
    iget-object v0, p0, Landroid/support/v4/app/aa$a;->d:Landroid/support/v4/content/f;

    invoke-virtual {v0, p0}, Landroid/support/v4/content/f;->b(Landroid/support/v4/content/f$b;)V
...
.method f()Z
    ...
    .line 337
    iget-object v1, p0, Landroid/support/v4/app/aa$a;->d:Landroid/support/v4/content/f;

    invoke-virtual {p0, v1}, Landroid/support/v4/app/aa$a;->a(Landroid/support/v4/content/f;)V
...
.method g()V
    ...
    iput-object v3, v1, Landroid/support/v4/app/q;->A:Ljava/lang/String;
    ...
    iget-object v3, p0, Landroid/support/v4/app/aa$a;->d:Landroid/support/v4/content/f;

    invoke-interface {v0, v3}, Landroid/support/v4/app/z$a;->a(Landroid/support/v4/content/f;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
