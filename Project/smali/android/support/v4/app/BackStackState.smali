...
.method public constructor <init>(Landroid/support/v4/app/h;)V
    ...
    .line 48
    iget-object v1, p1, Landroid/support/v4/app/h;->n:Ljava/util/ArrayList;
    ...
    .line 51
    iget-boolean v1, p1, Landroid/support/v4/app/h;->u:Z
    ...
    .line 57
    iget-object v0, p1, Landroid/support/v4/app/h;->n:Ljava/util/ArrayList;
    ...
    .line 66
    iget v0, p1, Landroid/support/v4/app/h;->t:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->c:I

    .line 67
    iget-object v0, p1, Landroid/support/v4/app/h;->w:Ljava/lang/String;
    ...
    .line 70
    iget-object v0, p1, Landroid/support/v4/app/h;->A:Ljava/lang/CharSequence;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->g:Ljava/lang/CharSequence;

    .line 71
    iget v0, p1, Landroid/support/v4/app/h;->B:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->h:I

    .line 72
    iget-object v0, p1, Landroid/support/v4/app/h;->C:Ljava/lang/CharSequence;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->i:Ljava/lang/CharSequence;

    .line 73
    iget-object v0, p1, Landroid/support/v4/app/h;->D:Ljava/util/ArrayList;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->j:Ljava/util/ArrayList;

    .line 74
    iget-object v0, p1, Landroid/support/v4/app/h;->E:Ljava/util/ArrayList;
...
.method public a(Landroid/support/v4/app/q;)Landroid/support/v4/app/h;
    ...
    invoke-direct {v3, p1}, Landroid/support/v4/app/h;-><init>(Landroid/support/v4/app/q;)V
    ...
    .line 104
    iget-object v5, p1, Landroid/support/v4/app/q;->l:Landroid/util/SparseArray;
    ...
    iput v0, v3, Landroid/support/v4/app/h;->p:I
    ...
    iput v0, v3, Landroid/support/v4/app/h;->r:I
    ...
    iput v0, v3, Landroid/support/v4/app/h;->s:I

    .line 121
    iget v0, p0, Landroid/support/v4/app/BackStackState;->c:I

    iput v0, v3, Landroid/support/v4/app/h;->t:I

    .line 122
    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->d:Ljava/lang/String;

    iput-object v0, v3, Landroid/support/v4/app/h;->w:Ljava/lang/String;

    .line 123
    iget v0, p0, Landroid/support/v4/app/BackStackState;->e:I

    iput v0, v3, Landroid/support/v4/app/h;->y:I

    .line 124
    iput-boolean v7, v3, Landroid/support/v4/app/h;->u:Z

    .line 125
    iget v0, p0, Landroid/support/v4/app/BackStackState;->f:I

    iput v0, v3, Landroid/support/v4/app/h;->z:I

    .line 126
    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->g:Ljava/lang/CharSequence;

    iput-object v0, v3, Landroid/support/v4/app/h;->A:Ljava/lang/CharSequence;

    .line 127
    iget v0, p0, Landroid/support/v4/app/BackStackState;->h:I

    iput v0, v3, Landroid/support/v4/app/h;->B:I

    .line 128
    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->i:Ljava/lang/CharSequence;

    iput-object v0, v3, Landroid/support/v4/app/h;->C:Ljava/lang/CharSequence;

    .line 129
    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->j:Ljava/util/ArrayList;

    iput-object v0, v3, Landroid/support/v4/app/h;->D:Ljava/util/ArrayList;

    .line 130
    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->k:Ljava/util/ArrayList;

    iput-object v0, v3, Landroid/support/v4/app/h;->E:Ljava/util/ArrayList;

    .line 131
    iget-boolean v0, p0, Landroid/support/v4/app/BackStackState;->l:Z

    iput-boolean v0, v3, Landroid/support/v4/app/h;->F:Z

    .line 132
    invoke-virtual {v3, v7}, Landroid/support/v4/app/h;->e(I)V
