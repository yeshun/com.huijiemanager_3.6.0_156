...
.method private getIpByHost(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/alibaba/sdk/android/httpdns/h;->f(Ljava/lang/String;)V
...
.method private getIpsByHost(Ljava/lang/String;)[Ljava/lang/String;
    ...
    :cond_0
    invoke-static {p1}, Lcom/alibaba/sdk/android/httpdns/k;->b(Ljava/lang/String;)Z
    ...
    :cond_1
    invoke-static {p1}, Lcom/alibaba/sdk/android/httpdns/k;->c(Ljava/lang/String;)Z
    ...
    :cond_3
    invoke-static {}, Lcom/alibaba/sdk/android/httpdns/w;->d()Z
    ...
    invoke-virtual {v0, p1}, Lcom/alibaba/sdk/android/httpdns/b;->a(Ljava/lang/String;)Lcom/alibaba/sdk/android/httpdns/d;

    move-result-object v0

    if-eqz v0, :cond_6

    invoke-virtual {v0}, Lcom/alibaba/sdk/android/httpdns/d;->b()Z
    ...
    new-instance v2, Lcom/alibaba/sdk/android/httpdns/n;

    sget-object v3, Lcom/alibaba/sdk/android/httpdns/s;->b:Lcom/alibaba/sdk/android/httpdns/s;

    invoke-direct {v2, p1, v3}, Lcom/alibaba/sdk/android/httpdns/n;-><init>(Ljava/lang/String;Lcom/alibaba/sdk/android/httpdns/s;)V

    invoke-interface {v1, v2}, Ljava/util/concurrent/ExecutorService;->submit(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Future;

    :cond_5
    invoke-virtual {v0}, Lcom/alibaba/sdk/android/httpdns/d;->a()[Ljava/lang/String;
    ...
    invoke-direct {v1, p1, v2}, Lcom/alibaba/sdk/android/httpdns/n;-><init>(Ljava/lang/String;Lcom/alibaba/sdk/android/httpdns/s;)V
    ...
    invoke-static {v0}, Lcom/alibaba/sdk/android/httpdns/h;->a(Ljava/lang/Throwable;)V
...
.method public static getService(Landroid/content/Context;Ljava/lang/String;)Lcom/alibaba/sdk/android/httpdns/HttpDnsService;
    ...
    invoke-static {p0}, Lcom/alibaba/sdk/android/httpdns/n;->setContext(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lcom/alibaba/sdk/android/httpdns/w;->a(Landroid/content/Context;)V

    invoke-static {p1}, Lcom/alibaba/sdk/android/httpdns/e;->d(Ljava/lang/String;)V

    invoke-static {}, Lcom/alibaba/sdk/android/httpdns/t;->a()Lcom/alibaba/sdk/android/httpdns/t;

    move-result-object v0

    invoke-virtual {v0, p0}, Lcom/alibaba/sdk/android/httpdns/t;->a(Landroid/content/Context;)V
...
.method public getIpsByHostAsync(Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-virtual {v1, p1}, Lcom/alibaba/sdk/android/httpdns/b;->a(Ljava/lang/String;)Lcom/alibaba/sdk/android/httpdns/d;

    move-result-object v1

    if-eqz v1, :cond_4

    invoke-virtual {v1}, Lcom/alibaba/sdk/android/httpdns/d;->b()Z
    ...
    invoke-virtual {v2, p1}, Lcom/alibaba/sdk/android/httpdns/v;->g(Ljava/lang/String;)V
    ...
    invoke-virtual {v1}, Lcom/alibaba/sdk/android/httpdns/d;->a()[Ljava/lang/String;
...
.method public setHTTPSRequestEnabled(Z)V
    ...
    invoke-static {p1}, Lcom/alibaba/sdk/android/httpdns/e;->setHTTPSRequestEnabled(Z)V
...
.method public setLogEnabled(Z)V
    ...
    invoke-static {p1}, Lcom/alibaba/sdk/android/httpdns/h;->setLogEnabled(Z)V
...
.method public setPreResolveAfterNetworkChanged(Z)V
    ...
    sput-boolean p1, Lcom/alibaba/sdk/android/httpdns/l;->b:Z
...
.method public setPreResolveHosts(Ljava/util/ArrayList;)V
    ...
    new-instance v3, Lcom/alibaba/sdk/android/httpdns/n;

    sget-object v4, Lcom/alibaba/sdk/android/httpdns/s;->b:Lcom/alibaba/sdk/android/httpdns/s;

    invoke-direct {v3, v0, v4}, Lcom/alibaba/sdk/android/httpdns/n;-><init>(Ljava/lang/String;Lcom/alibaba/sdk/android/httpdns/s;)V
...
.method public setTimeoutInterval(I)V
    ...
    invoke-static {p1}, Lcom/alibaba/sdk/android/httpdns/e;->setTimeoutInterval(I)V
