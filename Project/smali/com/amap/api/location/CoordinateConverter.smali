...
.field private b:Lcom/amap/api/location/CoordinateConverter$CoordType;

.field private c:Lcom/amap/api/location/DPoint;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/amap/api/location/CoordinateConverter;->b:Lcom/amap/api/location/CoordinateConverter$CoordType;

    iput-object v0, p0, Lcom/amap/api/location/CoordinateConverter;->c:Lcom/amap/api/location/DPoint;

    iput-object v0, p0, Lcom/amap/api/location/CoordinateConverter;->d:Lcom/amap/api/location/DPoint;

    iput-object p1, p0, Lcom/amap/api/location/CoordinateConverter;->a:Landroid/content/Context;
...
.method public declared-synchronized convert()Lcom/amap/api/location/DPoint;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/amap/api/location/CoordinateConverter;->b:Lcom/amap/api/location/CoordinateConverter$CoordType;
    ...
    :cond_0
    :try_start_1
    iget-object v0, p0, Lcom/amap/api/location/CoordinateConverter;->c:Lcom/amap/api/location/DPoint;
    ...
    iget-object v1, p0, Lcom/amap/api/location/CoordinateConverter;->b:Lcom/amap/api/location/CoordinateConverter$CoordType;
    ...
    :pswitch_1
    iget-object v0, p0, Lcom/amap/api/location/CoordinateConverter;->a:Landroid/content/Context;

    iget-object v1, p0, Lcom/amap/api/location/CoordinateConverter;->c:Lcom/amap/api/location/DPoint;
...
.method public declared-synchronized coord(Lcom/amap/api/location/DPoint;)Lcom/amap/api/location/CoordinateConverter;
    ...
    :cond_4
    iput-object p1, p0, Lcom/amap/api/location/CoordinateConverter;->c:Lcom/amap/api/location/DPoint;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized from(Lcom/amap/api/location/CoordinateConverter$CoordType;)Lcom/amap/api/location/CoordinateConverter;
    ...
    :try_start_0
    iput-object p1, p0, Lcom/amap/api/location/CoordinateConverter;->b:Lcom/amap/api/location/CoordinateConverter$CoordType;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public isAMapDataAvailable(DD)Z
    ...
    invoke-static {p1, p2, p3, p4}, Lcom/loc/c;->a(DD)Z
