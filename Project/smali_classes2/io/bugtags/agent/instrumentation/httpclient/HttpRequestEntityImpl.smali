.class public final Lio/bugtags/agent/instrumentation/httpclient/HttpRequestEntityImpl;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/bugtags/agent/instrumentation/httpclient/HttpRequestEntityImpl;->log:Lio/bugtags/agent/logging/AgentLog;

    return-void
.end method

.method public constructor <init>(Lorg/apache/http/HttpEntity;Lio/bugtags/agent/instrumentation/TransactionState;)V
    .locals 1
    ...
    .line 36
    iput-object p1, p0, Lio/bugtags/agent/instrumentation/httpclient/HttpRequestEntityImpl;->impl:Lorg/apache/http/HttpEntity;

    .line 37
    iput-object p2, p0, Lio/bugtags/agent/instrumentation/httpclient/HttpRequestEntityImpl;->transactionState:Lio/bugtags/agent/instrumentation/TransactionState;

    .line 39
    new-instance v0, Lio/bugtags/agent/instrumentation/httpclient/HttpRequestEntityImpl$1;

    invoke-direct {v0, p0}, Lio/bugtags/agent/instrumentation/httpclient/HttpRequestEntityImpl$1;-><init>(Lio/bugtags/agent/instrumentation/httpclient/HttpRequestEntityImpl;)V
...
.method private handleException(Ljava/lang/Exception;)V
    ...
    invoke-direct {p0, p1, v0}, Lio/bugtags/agent/instrumentation/httpclient/HttpRequestEntityImpl;->handleException(Ljava/lang/Exception;Ljava/lang/Long;)V
...
.method private handleException(Ljava/lang/Exception;Ljava/lang/Long;)V
    ...
    .prologue
    .line 144
    iget-object v0, p0, Lio/bugtags/agent/instrumentation/httpclient/HttpRequestEntityImpl;->transactionState:Lio/bugtags/agent/instrumentation/TransactionState;
    ...
    .line 157
    sget-object v1, Lio/bugtags/agent/instrumentation/httpclient/HttpRequestEntityImpl;->log:Lio/bugtags/agent/logging/AgentLog;
...
.method public consumeContent()V
    ...
    .line 49
    :try_start_0
    iget-object v0, p0, Lio/bugtags/agent/instrumentation/httpclient/HttpRequestEntityImpl;->impl:Lorg/apache/http/HttpEntity;
    ...
    .line 51
    invoke-direct {p0, v0}, Lio/bugtags/agent/instrumentation/httpclient/HttpRequestEntityImpl;->handleException(Ljava/lang/Exception;)V
...
.method public fillRequestData()V
    ...
    .prologue
    .line 127
    iget-object v0, p0, Lio/bugtags/agent/instrumentation/httpclient/HttpRequestEntityImpl;->countingOutputStream:Lio/bugtags/agent/instrumentation/io/CountingOutputStream;
    ...
    .line 133
    iget-object v2, p0, Lio/bugtags/agent/instrumentation/httpclient/HttpRequestEntityImpl;->transactionState:Lio/bugtags/agent/instrumentation/TransactionState;
...
.method public getContent()Ljava/io/InputStream;
    ...
    iget-object v1, p0, Lio/bugtags/agent/instrumentation/httpclient/HttpRequestEntityImpl;->impl:Lorg/apache/http/HttpEntity;
...
.method public streamError(Lio/bugtags/agent/instrumentation/io/StreamCompleteEvent;)V
    ...
    invoke-direct {p0, v0, v1}, Lio/bugtags/agent/instrumentation/httpclient/HttpRequestEntityImpl;->handleException(Ljava/lang/Exception;Ljava/lang/Long;)V
...
.method public writeTo(Ljava/io/OutputStream;)V
    ...
    iput-object v0, p0, Lio/bugtags/agent/instrumentation/httpclient/HttpRequestEntityImpl;->countingOutputStream:Lio/bugtags/agent/instrumentation/io/CountingOutputStream;

    .line 102
    iget-object v0, p0, Lio/bugtags/agent/instrumentation/httpclient/HttpRequestEntityImpl;->impl:Lorg/apache/http/HttpEntity;

    iget-object v1, p0, Lio/bugtags/agent/instrumentation/httpclient/HttpRequestEntityImpl;->countingOutputStream:Lio/bugtags/agent/instrumentation/io/CountingOutputStream;
