.class public final Lio/bugtags/agent/instrumentation/loopj149/HttpResponseEntityImpl;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/bugtags/agent/instrumentation/loopj149/HttpResponseEntityImpl;->log:Lio/bugtags/agent/logging/AgentLog;

    return-void
.end method

.method public constructor <init>(Lcz/msebera/android/httpclient/HttpEntity;Lio/bugtags/agent/instrumentation/TransactionState;J)V
    .locals 1
    ...
    .line 45
    iput-object p1, p0, Lio/bugtags/agent/instrumentation/loopj149/HttpResponseEntityImpl;->impl:Lcz/msebera/android/httpclient/HttpEntity;

    .line 46
    iput-object p2, p0, Lio/bugtags/agent/instrumentation/loopj149/HttpResponseEntityImpl;->transactionState:Lio/bugtags/agent/instrumentation/TransactionState;

    .line 47
    iput-wide p3, p0, Lio/bugtags/agent/instrumentation/loopj149/HttpResponseEntityImpl;->contentLengthFromHeader:J
...
.method private addTransactionAndErrorData(Lio/bugtags/agent/instrumentation/TransactionState;)V
    ...
    .prologue
    .line 156
    invoke-direct {p0}, Lio/bugtags/agent/instrumentation/loopj149/HttpResponseEntityImpl;->fillResponseData()V
    ...
    .line 166
    sget-object v1, Lio/bugtags/agent/instrumentation/loopj149/HttpResponseEntityImpl;->log:Lio/bugtags/agent/logging/AgentLog;
...
.method private fillResponseData()V
    ...
    .prologue
    .line 170
    iget-object v0, p0, Lio/bugtags/agent/instrumentation/loopj149/HttpResponseEntityImpl;->contentStream:Lio/bugtags/agent/instrumentation/io/CountingInputStream;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lio/bugtags/agent/instrumentation/loopj149/HttpResponseEntityImpl;->transactionState:Lio/bugtags/agent/instrumentation/TransactionState;
    ...
    .line 172
    iget-object v1, p0, Lio/bugtags/agent/instrumentation/loopj149/HttpResponseEntityImpl;->transactionState:Lio/bugtags/agent/instrumentation/TransactionState;
    ...
    .line 174
    iget-object v1, p0, Lio/bugtags/agent/instrumentation/loopj149/HttpResponseEntityImpl;->contentStream:Lio/bugtags/agent/instrumentation/io/CountingInputStream;
    ...
    .line 179
    iget-object v2, p0, Lio/bugtags/agent/instrumentation/loopj149/HttpResponseEntityImpl;->transactionState:Lio/bugtags/agent/instrumentation/TransactionState;
...
.method private handleException(Ljava/lang/Exception;)V
    ...
    invoke-direct {p0, p1, v0}, Lio/bugtags/agent/instrumentation/loopj149/HttpResponseEntityImpl;->handleException(Ljava/lang/Exception;Ljava/lang/Long;)V
...
.method private handleException(Ljava/lang/Exception;Ljava/lang/Long;)V
    ...
    invoke-static {v0, p1}, Lio/bugtags/agent/instrumentation/loopj149/LoopjTransactionStateUtil;->setErrorCodeFromException(Lio/bugtags/agent/instrumentation/TransactionState;Ljava/lang/Exception;)V
...
.method public consumeContent()V
    ...
    .line 52
    :try_start_0
    iget-object v0, p0, Lio/bugtags/agent/instrumentation/loopj149/HttpResponseEntityImpl;->impl:Lcz/msebera/android/httpclient/HttpEntity;
    ...
    .line 54
    invoke-direct {p0, v0}, Lio/bugtags/agent/instrumentation/loopj149/HttpResponseEntityImpl;->handleException(Ljava/lang/Exception;)V
...
.method public getContent()Ljava/io/InputStream;
    ...
    instance-of v0, v0, Lcz/msebera/android/httpclient/message/AbstractHttpMessage;
    ...
    check-cast v0, Lcz/msebera/android/httpclient/message/AbstractHttpMessage;

    .line 68
    const-string v3, "Transfer-Encoding"

    invoke-virtual {v0, v3}, Lcz/msebera/android/httpclient/message/AbstractHttpMessage;->getLastHeader(Ljava/lang/String;)Lcz/msebera/android/httpclient/Header;
    ...
    iget-object v1, p0, Lio/bugtags/agent/instrumentation/loopj149/HttpResponseEntityImpl;->impl:Lcz/msebera/android/httpclient/HttpEntity;
    ...
    iput-object v0, p0, Lio/bugtags/agent/instrumentation/loopj149/HttpResponseEntityImpl;->contentStream:Lio/bugtags/agent/instrumentation/io/CountingInputStream;
    ...
    instance-of v0, v0, Lcz/msebera/android/httpclient/entity/HttpEntityWrapper;
    ...
    check-cast v0, Lcz/msebera/android/httpclient/entity/HttpEntityWrapper;

    .line 74
    invoke-virtual {v0}, Lcz/msebera/android/httpclient/entity/HttpEntityWrapper;->isChunked()Z
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public streamComplete(Lio/bugtags/agent/instrumentation/io/StreamCompleteEvent;)V
    ...
    .line 138
    iget-wide v0, p0, Lio/bugtags/agent/instrumentation/loopj149/HttpResponseEntityImpl;->contentLengthFromHeader:J
    ...
    iget-wide v2, p0, Lio/bugtags/agent/instrumentation/loopj149/HttpResponseEntityImpl;->contentLengthFromHeader:J
    ...
    invoke-direct {p0, v0}, Lio/bugtags/agent/instrumentation/loopj149/HttpResponseEntityImpl;->addTransactionAndErrorData(Lio/bugtags/agent/instrumentation/TransactionState;)V
...
.method public streamError(Lio/bugtags/agent/instrumentation/io/StreamCompleteEvent;)V
    ...
    invoke-static {v0, v1}, Lio/bugtags/agent/instrumentation/loopj149/LoopjTransactionStateUtil;->setErrorCodeFromException(Lio/bugtags/agent/instrumentation/TransactionState;Ljava/lang/Exception;)V
...
.method public writeTo(Ljava/io/OutputStream;)V
    ...
    invoke-direct {p0, v0, v1}, Lio/bugtags/agent/instrumentation/loopj149/HttpResponseEntityImpl;->handleException(Ljava/lang/Exception;Ljava/lang/Long;)V
